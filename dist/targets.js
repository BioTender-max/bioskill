...
export const TARGETS = {
    "claude-code": {
        ...
        postInstallHint: "Restart Claude Code or run `/skill reload` to pick up the new skills.",
    },
    mimocode: {
        id: "mimocode",
        label: "MiMo-Code",
    ...
    generic: {
        ...
        postInstallHint: "Set $BIOSKILL_TARGET_DIR to point at your agent's skill directory, or pass --dir.",
    },
};
